...
class HomeFeedViewModel @Inject constructor(
    ...
    init {
        _state.value = _state.value.copy(specialProduct = repository.getPaginatedSpecialItemProducts().cachedIn(viewModelScope))
        _state.value = _state.value.copy(bestProducts = repository.getPaginatedBestProducts().cachedIn(viewModelScope))
        _state.value = _state.value.copy(bestDeals = repository.getPaginatedBestDealsProducts().cachedIn(viewModelScope))
        /*getSpecialItem()
        getBestDealItem()
        getBestProductItem()*/
    }
